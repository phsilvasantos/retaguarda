...
type
  TFormRelatorioProdutosVendidos = class(TFormRelatorioTEMPLATE)
    ...
    TblTemporariaCPITN2VLRQDEVERIAVENDER: TFloatField;
    ...
    SQLTrocasCPITN3QTD: TFloatField;
    SQLTrocasVENDICOD: TIntegerField;
    SQLTrocasCUPOA13ID: TStringField;
    SQLTrocasCLIEA13ID: TStringField;
    SQLTrocasCPITN2VLRQDEVERIAVENDER: TFloatField;
    TblTemporariaCPITN3QTDTROCA: TFloatField;
    ...
    edtCultura: TEdit;
    Label9: TLabel;
    SQLTrocasCPITN3QTDTROCA: TFloatField;
