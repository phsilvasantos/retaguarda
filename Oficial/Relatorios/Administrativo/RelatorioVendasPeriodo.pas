...
type
  TFormRelatorioVendasPeriodo = class(TFormRelatorioTEMPLATE)
    ...
    TblVendasPeriodoRecConsigRECEN2VLRRECTO: TBCDField;
    ...
    TblVendaChequesCTRCN2VLR: TBCDField;
    ...
    TblVendaConsigCUPON2TOTITENS: TBCDField;
    TblVendaConsigCUPON2ACRESC: TBCDField;
    TblVendaConsigCUPON2DESC: TBCDField;
    ...
    TblTemporariaCUPON2DESC: TBCDField;
    TblTemporariaTOTAL: TFloatField;
    TblTemporariaCUPON3BONUSTROCA: TBCDField;
    TblTemporariaNROITENS: TBCDField;
...
//  '';
  ...
  if VendConsig_Cheques.Checked then
    begin
      ...
      CopyQueryTable(SQLVendasConsig, TblVendaConsig);
      ...
      SQLCheques.Open ;
      CopyQueryTable(SQLCheques, TblVendaCheques) ;
