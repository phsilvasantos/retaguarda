  ...
  object SQLVendaMarca: TRxQuery
    ...
    SQL.Strings = (
      ...
      'from'
        ...
        '   left outer join MARCA MARCA on MARCA.MARCICOD = PRODUTO.MARCI' +
        'COD'
    ...
    Left = 424
    Top = 5
    object SQLVendaMarcaMARCICOD: TIntegerField
      FieldName = 'MARCICOD'
    end
    object SQLVendaMarcaMARCA60DESCR: TStringField
      FieldName = 'MARCA60DESCR'
      FixedChar = True
      Size = 60
    end
