inherited FormRelatorioFluxoCaixa: TFormRelatorioFluxoCaixa
  ...
  object SQLReceber: TRxQuery
    ...
    SQL.Strings = (
        ...
        ' as VALORRECEBER, sum(CONTASRECEBER.CTRCN2TOTREC + CONTASRECEBER' +
        '.CTRCN2TOTJUROREC) VALORRECEBIDO,'
  ...
  object SQLPagar: TRxQuery
    ...
    SQL.Strings = (
        ...
        'select sum(CONTASPAGAR.CTPGN3VLR - CONTASPAGAR.CTPGN2TOTPAG - CO' +
        'NTASPAGAR.CTPGN2DESCPROMO) as VALORPAGAR, CONTASPAGAR.PORTICOD, ' +
  ...
  object SQLQuitados: TRxQuery
    ...
    SQL.Strings = (
        ...
        'select sum(CONTASRECEBER.CTRCN2VLR - CONTASRECEBER.CTRCN2TOTREC)' +
        ' as VALORRECEBER, sum(CONTASRECEBER.CTRCN2TOTREC + CONTASRECEBER' +
        '.CTRCN2TOTJUROREC + CONTASRECEBER.CTRCN2TOTMULTAREC) VALORRECEBI' +
        'DO,'
