inherited FormTelaLancamentoGrade: TFormTelaLancamentoGrade
  ...
  object TblQtde: TMemoryTable
    ...
    object TblQtdeFloatField16: TFloatField
      FieldName = '16'
      Visible = False
      DisplayFormat = '#,###'
      EditFormat = '#,###'
    end
    object TblQtdeFloatField17: TFloatField
      FieldName = '17'
      Visible = False
      DisplayFormat = '#,###'
      EditFormat = '#,###'
    end
    object TblQtdeFloatField18: TFloatField
      FieldName = '18'
      Visible = False
      DisplayFormat = '#,###'
      EditFormat = '#,###'
    end
    object TblQtdeFloatField19: TFloatField
      FieldName = '19'
      Visible = False
      DisplayFormat = '#,###'
      EditFormat = '#,###'
    end
    object TblQtdeFloatField20: TFloatField
      FieldName = '20'
      Visible = False
      DisplayFormat = '#,###'
      EditFormat = '#,###'
    end
    object TblQtdeFloatField21: TFloatField
      FieldName = '21'
      Visible = False
      DisplayFormat = '#,###'
      EditFormat = '#,###'
