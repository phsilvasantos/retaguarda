...
//    VlrFrete := SQLListaVLRCOMPRA.Value * (SQLListaPERCFRETE.Value/100) else VlrFrete := 0;
  if SQLListaVLR_DESCONTO.Value > 0 then
    VlrDesc := SQLListaVLR_DESCONTO.Value else VlrDesc := 0;
...
procedure TFormTelaListaPreco.FormShow(Sender: TObject);
begin
  inherited;
  if editRetorno.text <> '' then
  begin
