inherited FormTelaListaPreco: TFormTelaListaPreco
  ...
  inherited AdvOfficeStatusBarOfficeStyler1: TAdvOfficeStatusBarOfficeStyler
    ...
    PanelAppearanceLight.Color = 16120314
    PanelAppearanceLight.ColorTo = 11059392
    ...
    PanelAppearanceDark.Color = 15462127
    PanelAppearanceDark.ColorTo = 8296600
  ...
  object SQLLista: TRxQuery
    ...
    object SQLListaVLR_DESCONTO: TFloatField
      FieldName = 'VLR_DESCONTO'
      Origin = 'DB.LISTAPRECO.VLR_DESCONTO'
      OnChange = SQLListaVLR_DESCONTOChange
      DisplayFormat = '#0.00'
      EditFormat = '#0.00'
    end
    object SQLListaVLR_FRETE: TFloatField
      FieldName = 'VLR_FRETE'
