...
Begin
  ...
  if (not ckC400.Checked) and (not ck170NFCe.Checked) then
    begin
      ...
      'N.CUPOCSTATUS = ''A'')';
      addLog(zPesquisa.SQL.Text,ExtractFilePath(Application.ExeName) + 'LogSqlProduto.txt');
      zPesquisa.Open;
      ...
      While Not zPesquisa2.Eof do
        begin
          Try
            ...
            if (zPesquisa2.FieldByName('PERC_REDUCAO_BASE_CALCULO').Value > 0) then
              VL_RED_BC := VL_OPR - RetornaValor('CPITN2BASEICMS')
            else
              VL_RED_BC := 0;
